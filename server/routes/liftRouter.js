...
import { createLift, updateLift, readLifts, deleteLift, readLiftByDate } from "../controllers/liftController.js"; 
...
router.get("/liftget", authenticateToken, readLiftByDate); // Fetch lifts by date
